...
M.setup = function()
  ...
  require "hydra" {
    ...
    heads = {
      ...
      {
        "<C-1>",
        function() require("bufferline").go_to(1, go_to_buffer_abs) end,
        { desc = false },
      },
      {
        "<C-2>",
        function() require("bufferline").go_to(2, go_to_buffer_abs) end,
        { desc = false },
      },
      {
        "<C-3>",
        function() require("bufferline").go_to(3, go_to_buffer_abs) end,
        { desc = false },
      },
      {
        "<C-4>",
        function() require("bufferline").go_to(4, go_to_buffer_abs) end,
        { desc = false },
      },
      {
        "<C-5>",
        function() require("bufferline").go_to(5, go_to_buffer_abs) end,
        { desc = false },
      },
      {
        "<C-6>",
        function() require("bufferline").go_to(6, go_to_buffer_abs) end,
        { desc = false },
      },
      {
        "<C-7>",
        function() require("bufferline").go_to(7, go_to_buffer_abs) end,
        { desc = false },
      },
      {
        "<C-8>",
        function() require("bufferline").go_to(8, go_to_buffer_abs) end,
        { desc = false },
      },
      {
        "<C-9>",
        function() require("bufferline").go_to(9, go_to_buffer_abs) end,
        { desc = false },
      },
